 ...
 *
 */
export declare class Job<DataType = any, ReturnType = any, NameType extends string = string, ProgressType extends JobProgress = JobProgress> implements MinimalJob<DataType, ReturnType, NameType, ProgressType> {
